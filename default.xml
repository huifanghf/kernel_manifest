...
<manifest>
  ...
  <remote  name="github"
    	   fetch="https://github.com/huifanghf" />
  ...
  <project path="kernel-5.10" name="android_kernel_oneplus_mt6895" remote="github" revision="15" >
    <linkfile dest="build.config" src="build.config.oplus6895" />
  </project>

  <project path="vendor" name="android_kernel_modules_oneplus_mt6895" remote="github" revision="15" />
